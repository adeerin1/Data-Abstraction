...
public:
	...
	const_iterator erase(const_iterator position); //erase element at that index
	void set(const T &value,int index); //change the value of an element at a given index
	void print() {
		std::cout << "Ct: " << ct << std::endl;
		std::cout << "File ct: " << readCount() << std::endl;
